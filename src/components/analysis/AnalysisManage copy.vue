    ...
    <div style="width: 40%; margin-top: 50px;">
        <div style="margin-bottom: 5px;">
            ...
            <el-button type="primary" style="margin-left: 5px;" @click="loadData">検索</el-button>
             <el-button type="success" style="margin-left: 5px;" @click="downloadPdf">グラフ出力</el-button>
             <el-button type="danger" style="margin-left: 5px;" @click="downloadExcel">Excel出力</el-button>
        </div>
