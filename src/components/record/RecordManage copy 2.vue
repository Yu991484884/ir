<template>
  <div>
    <div style="margin-bottom: 5px;">
      ...
      <el-input v-model="factor" placeholder="要因検索" suffix-icon="el-icon-search" style="width: 200px;margin-bottom: 10px;"
    ...
    <el-table :data="tableData" height="1000" style="width: 100%"
      ...
      <el-table-column prop="affiliationcode" label="営業所" width="140">
      </el-table-column>
